                ...
                if (message[0].equalsIgnoreCase("-lyrics")) {
                        ...
                        if (!event.getGuild().getAudioManager().isConnected()) {
                                ...
                                EmbedBuilder embedd = new EmbedBuilder();
                                        embedd.setAuthor("❌ I have exceeded the MONTHLY quota for Requests on my current plan")
                                                .setTitle("So -lyrics is temporary down")
                                                        .setColor(15844367)
                                                        .setFooter("Developed by Daly#3068 ❤️",
                                                                        "https://cdn.discordapp.com/avatars/392041081983860746/316401c64397974a28995adbe5ee5ed8.png");
                                        event.getChannel().sendMessageEmbeds(embedd.build()).queue();
                                        return;
                        }//When you get back delete this bracket and uncomment the rest                
